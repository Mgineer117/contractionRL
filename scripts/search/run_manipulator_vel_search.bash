...
#   bash scripts/search/run_manipulator_vel_search.bash --algorithm PPO
#   bash scripts/search/run_manipulator_vel_search.bash --sweep_id <ID>
...
ALGORITHM="SAC"
COUNT=20
NUM_ENVS=256       # Franka is lighter; more envs ok
TIMESTEPS=50000
LOG_DIR="logs/search"
SWEEP_ID=""
...
LOG_FILE="$LOG_DIR/manipulator_vel_${ALGORITHM}_${SWEEP_ID}.txt"
