...
LOG_DIR="logs/search/quadruped_vel_tracking_ppo"
mkdir -p $LOG_DIR

echo "Initializing WandB Sweep for Quadruped-VelTracking-v0 (ppo)..."
SWEEP_ID=$(python search/quadruped_vel_tracking/ppo.py | tail -n 1)
