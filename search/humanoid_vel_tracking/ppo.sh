...
LOG_DIR="logs/search/humanoid_vel_tracking_ppo"
mkdir -p $LOG_DIR

echo "Initializing WandB Sweep for Humanoid-VelTracking-v0 (ppo)..."
SWEEP_ID=$(python search/humanoid_vel_tracking/ppo.py | tail -n 1)
