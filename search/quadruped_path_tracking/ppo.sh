...
LOG_DIR="logs/search/quadruped_path_tracking_ppo"
mkdir -p $LOG_DIR

echo "Initializing WandB Sweep for Quadruped-PathTracking-v0 (ppo)..."
SWEEP_ID=$(python search/quadruped_path_tracking/ppo.py | tail -n 1)
