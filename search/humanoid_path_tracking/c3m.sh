...
LOG_DIR="logs/search/humanoid_path_tracking_c3m"
mkdir -p $LOG_DIR

echo "Initializing WandB Sweep for Humanoid-PathTracking-v0 (c3m)..."
SWEEP_ID=$(python search/humanoid_path_tracking/c3m.py | tail -n 1)
