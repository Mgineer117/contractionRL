...
LOG_DIR="logs/search/manipulator_path_tracking_c3m"
mkdir -p $LOG_DIR

echo "Initializing WandB Sweep for Manipulator-PathTracking-v0 (c3m)..."
SWEEP_ID=$(python search/manipulator_path_tracking/c3m.py | tail -n 1)
