...
LOG_DIR="logs/search/manipulator_path_tracking_ppo"
mkdir -p $LOG_DIR

echo "Initializing WandB Sweep for Manipulator-PathTracking-v0 (ppo)..."
SWEEP_ID=$(python search/manipulator_path_tracking/ppo.py | tail -n 1)
